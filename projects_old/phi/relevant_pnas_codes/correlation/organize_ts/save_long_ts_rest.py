...
for state in brain_states:
    ...
    save_paths = ['/home/user/Desktop/data_phi/time_series/' + state + '/Aud',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Cingulo',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/DMN',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Dorsal',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Fronto',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Retro',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/SMhand',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/SMmouth',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Ventral',
                  '/home/user/Desktop/data_phi/time_series/' + state + '/Vis']
