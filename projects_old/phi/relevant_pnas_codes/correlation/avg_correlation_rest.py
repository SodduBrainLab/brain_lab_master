...
main_path = '/home/user/Desktop/data_phi/time_series/'
ts_name = 'ts_all.npy'
...
for network in networks:
    ...
    for state in brain_states:
        ...
        makedir2(path+'correlation/'+state +'/')

        makedir2(path +'correlation/'+ state + '/' + network + '/')

        save_path = path +'correlation/'+ state + '/' + network + '/'
